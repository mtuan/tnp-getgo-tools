...
- Portrait usually benefits from taller edge framing, compact characters, and a strong footer meadow. Landscape can extend terrain laterally, move the character beside content, and use wider header/footer scenery.
...
Reject work that feels auto-filled: empty gradients with a few stickers, generic repeated flowers, characters unrelated to the page task, a full screenshot used as a background, or CSS controls visually disconnected from the illustration system. A finished design has clear focal hierarchy, deliberate whitespace, coherent edge framing, balanced color, and intentionally integrated semantic UI.
