...
export interface DialogFrameProps { title: string; busy: boolean; error: string | null; children: ReactNode; onClose(): void; onSubmit(event: FormEvent): void; onDelete?: () => Promise<void>; presentation?: "drawer" | "modal" | "embedded"; submitLabel?: string; embeddedFooter?: boolean; className?: string; hideFooter?: boolean; footer?: ReactNode }

export function DialogFrame({ title, busy, error, children, onClose, onSubmit, onDelete, presentation = "drawer", submitLabel = "Save", embeddedFooter = false, className = "", hideFooter = false, footer }: DialogFrameProps) {
