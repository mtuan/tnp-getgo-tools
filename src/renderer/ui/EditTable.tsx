...
export function EditTable<T extends object>({ columns, rows, rowKey, onRowChange, onRowAdd, onRowDelete, reorderable = false, onRowsReorder, addLabel = "Add row", emptyText = "No rows yet.", ariaLabel }: EditTableProps<T>) {
  ...
  return <div className="edit-table">
    ...
    {onRowAdd && <button type="button" className="edit-table-add" onClick={onRowAdd}><Plus />{addLabel}</button>}
  </div>
}
