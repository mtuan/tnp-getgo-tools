...
const api: DesktopApi = {
  ...
  getDesignReferenceUrl: (id, pageId, viewport, theme) => ipcRenderer.invoke("designs:reference:url", id, pageId, viewport, theme),
  ...
  addScreenshot: (projectId, imageDataUrl, metadata, domSnapshot) => ipcRenderer.invoke("screenshots:add", projectId, imageDataUrl, metadata, domSnapshot),
