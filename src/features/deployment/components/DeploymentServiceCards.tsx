...
import type { AppSettings, DeploymentComponent, DeploymentOperation, DeploymentStateSnapshot } from "../../../shared/domain/models";
  ...
  return <>
    <ui.Panel className="deployment-card">
      <ui.PanelBody>
        ...
        <div className="deployment-card-actions">
          <ui.Button icon={<Eye />} aria-label={copy.viewLogs} title={copy.viewLogs} disabled={!hasLogs("firebase")} onClick={() => onViewLogs("firebase")} />
    ...
    <ui.Panel className="deployment-card">
      <ui.PanelBody>
        ...
        <div className="deployment-card-actions">
          <ui.Button icon={<Eye />} aria-label={copy.viewLogs} title={copy.viewLogs} disabled={!hasLogs("web")} onClick={() => onViewLogs("web")} />
