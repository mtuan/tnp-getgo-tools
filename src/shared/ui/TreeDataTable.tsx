...
export function TreeDataTable<T>({ rows, columns, rowKey, ariaLabel, emptyText = "No rows yet.", onRowClick, toggleParentOnRowClick = false, singleExpand = false, defaultExpandedKeys = [], horizontalScroll = false, onExpand, renderIdentity }: {
  rows: TreeDataRow<T>[];
